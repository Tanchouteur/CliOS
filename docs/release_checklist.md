...
Production locale RC : `python3 tools/build_release.py --channel beta --base-url https://github.com/Tanchouteur/CliOS/releases/download/v2.0.1-rc.1`.
...
python3 tools/release_cli.py stage 2.0.1-rc.1 # demande le staging au helper root
