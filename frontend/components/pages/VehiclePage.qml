...
Item {
    ...
    Component.onCompleted: {
        if (bridge.stats.fuel_price !== undefined) {
            root.fuelPrice = bridge.stats.fuel_price
        }
    }
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                root.fuelPrice = Math.max(0.0, Math.round((root.fuelPrice - 0.01) * 100) / 100)
                                bridge.updateFuelPrice(root.fuelPrice)
                            }
                    ...
                    Rectangle {
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: root.fuelPrice.toFixed(2) + " €/L"
                            color: T.Theme.main
                            font.pixelSize: 30
                            font.bold: true
                        }
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent
                            onClicked: {
                                root.fuelPrice = Math.round((root.fuelPrice + 0.01) * 100) / 100
                                bridge.updateFuelPrice(root.fuelPrice)
                            }
